            ...
            pub mod greetable {
                ...
                macro_rules! __export_component_greet_greetable_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        _post_return_name(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_name::<$ty > (arg0) } }
                        #[unsafe (export_name = "component:greet/greetable#greet")]
                        unsafe extern "C" fn export_greet(arg0 : * mut u8, arg1 : usize,)
                        -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_greet_cabi::<$ty > (arg0, arg1) } } #[unsafe (export_name
                        = "cabi_post_component:greet/greetable#greet")] unsafe extern "C"
                        fn _post_return_greet(arg0 : * mut u8,) { unsafe {
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:greet:greetable-provider:encoded world"
)]
#[doc(hidden)]
